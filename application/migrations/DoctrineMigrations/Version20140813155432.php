 ...
 */
class Version20140813155432 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        $this->addSql("DROP PROCEDURE `es_sp_getProductBySlug`");
        $this->addSql("
            ...
            BEGIN
                ...
                SELECT p.id_product as id_product, p.promo_type, p.condition, p.slug,p.brand_id as brand_id, p.brand_other_name as custombrand, p.name as product_name, p.description as description, 
                    ...
                    p.is_sold_out, p.is_cod, p.discount, s.name as style_name, b.name as brand_name, p.member_id as sellerid, m.nickname as sellernickname, m.username as sellerusername, m.imgurl as userpic, o_success, o_message
                    FROM es_product p 
