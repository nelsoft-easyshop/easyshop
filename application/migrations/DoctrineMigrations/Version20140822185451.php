 ...
 */
class Version20140822185451 extends AbstractMigration
{
        ...
        $this->addSql("
            ...
            BEGIN
                ...
                DECLARE cur CURSOR FOR
                    ...
                    FROM es_product
                    WHERE member_id = i_memberid AND is_delete = 0 AND is_draft = 0
                    GROUP BY cat_id;
                ...
                SELECT t.parent_cat, t.cat_id, t.prd_count, IF(t.cat_id != 1,c.name,'NULL') as p_cat_name, IF(t.cat_id != 1, c.slug, 'null') as p_cat_slug, ci.path as p_cat_img
                FROM tbl_prdcat t
                LEFT JOIN es_cat c
                    ON t.parent_cat = c.id_cat
                LEFT JOIN es_cat_img ci
                    ON ci.id_cat = t.parent_cat;
