 ...
 */
class Version20140827210346 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql("INSERT INTO `easyshop`.`es_payment_method` (`id_payment_method`, `name`) VALUES ('6', 'PROMO')");
...
BEGIN
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("DELETE FROM `easyshop`.`es_payment_method` WHERE `id_payment_method`='6'");
        $this->addSql("DROP PROCEDURE IF EXISTS `es_sp_Payment_order`");
        $this->addSql("
