...
<section class="section-login">
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-body div-merge-container" align="center">
                <p>
                    The <a href="/<?=$member->getSlug()?>"><?=$member->getEmail()?></a> email account is already registered to an existing user. <br/>If you own this account would you like to merge this into a single account?
                </p>
    ...
    <div id="basic-modal-content-proceed">
        <div class="modal-text-content">
            We've just sent a verification message to <?=$member->getEmail()?> account's inbox.<br/> Please login to your email account and follow the instructions provided to complete this process.
        </div>
        <center>
    ...
    <div id="dataContainer" data-id="<?=$oauthId?>" data-provider="<?=$oauthProvider?>" data-email="<?=$member->getEmail()?>" data-mId="<?=$member->getIdMember()?>"  data-uname="<?=html_escape($member->getUsername())?>"></div>
</section>
<br/>
<br/>
<script src='/assets/js/src/SocialMediaMerge.js' type='text/javascript'></script>
