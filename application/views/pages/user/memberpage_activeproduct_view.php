	...
	<div class="post_items_content content-paging">
		...
		<div class="post_item_content_right">
			...
			<div class="price_container" data-prodprice="<?php echo $active_product['price'];?>">
				<p><span class="fm1 f24 orange">PHP <?php echo number_format($active_product['price'],2,'.',',');?></span><br />Price<br/>
				...
				<p><span class="fm1 f24"><?php echo $active_product['availability'];?></span>
