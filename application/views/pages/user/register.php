            ...
            <div class="grid-6">
                                ...
                                <?php echo form_close();?>
                                        <div class="dialog t_and_c">
                                            ...
                                            <p> EasyShop.ph is the registered owner of and holds the title to and all interest in the trademark "EasyShop.ph" and the trade name EasyShop.ph and owns all intellectual property rights to and all interest in the trade name EasyShop.ph as well as the EasyShop.ph logo.
                ...
                <ul>
                    ...
                    <li class="social_media_container">
                        <div class="social_media">
                            ...
                            <ul>
                                <li>
                                    <div class="fb-like" data-href="<?php echo $facebook; ?>/EasyShopPhilippines" data-width="200" data-layout="button" data-action="like" data-show-faces="false" data-share="false"></div>
                                </li>
                                <li>
                                    <a href="<?php echo $twitter; ?>/EasyShopPH" class="twitter-follow-button" data-show-count="false" data-size="large" data-show-screen-name="false">Follow @EasyShopPH</a>
