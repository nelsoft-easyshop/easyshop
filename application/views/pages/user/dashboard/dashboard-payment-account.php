        ...
        <div class="bank-account-item mrgn-bttm-15">
            <div class="col-xs-8">
                <div class="pd-top-10">
                    ...
                    <span class="col-xs-7 col-sm-8">BDO - Banco de Oro</span>
                </div>
                <div class="clear pd-top-10">
                    <span class="col-xs-5 col-sm-4 bank-label">Account Name:</span>
                    <span class="col-xs-7 col-sm-8">Juan Dela Cruz</span>
                </div>
                <div class="clear pd-top-10">
                    <span class="col-xs-5 col-sm-4 bank-label">Account Number:</span>
                    <span class="col-xs-7 col-sm-8">1234567890</span>
                </div>
                <div class="clear"></div>
            </div>
            <div class="col-xs-4 bank-account-item-btns">
                <span class="btn default-account">Default Account</span>
