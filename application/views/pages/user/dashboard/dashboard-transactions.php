        ...
        <div class="div-tab">
            <div class="div-tab-inner">
                <div class="transaction-tabs">
                    <ul class="idTabs">
                        <li><a href="#on-going-transaction" class="on-going-transaction-header selected">On going</a></li>
            ...
            <div class="div-tab-inner">
                <div class="transaction-tabs">
                    <ul class="idTabs">
                        ...
                        <li><a href="#completed-transaction" class="completed-transaction-header selected">Completed</a></li>
                    </ul>
                </div>
                <div class="row">
