            ...
            <?php echo form_open('',array('id'=>'deliverAddressForm','class' => 'form-horizontal', 'role' => 'form'));?>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Telephone Number : </label>
                     <div class="col-sm-8">
                        <input type="text" class="text-info text-required" value="<?php echo html_escape(($address) ? $address->getTelephone() : '')?>" id="consigneeLandLine" name="c_telephone" placeholder="Enter your telephone number here (e.g. 123-1234)">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-map">
                        <span id="locationMarkedText">
                            <?php if($address):?>
                                <?php if((int)$address->getLat() === 0 && (int)$address->getLng() === 0): ?>
                                    <?php echo "Location not marked" ?>
                                <?php else: ?>
                                    <?php echo "Location Marked" ?>
                                <?php endif; ?>
                            <?php else: ?>
                                <?php echo "Location not marked" ?>
                            <?php endif; ?>
