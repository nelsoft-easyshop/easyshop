            ...
            <?php echo form_open('',array('id'=>'deliverAddressForm','class' => 'form-horizontal', 'role' => 'form'));?>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Mobile Number : </label>
                     <div class="col-sm-8">
                        <input type="text" class="text-info text-required" value="<?php echo html_escape(($address) ? $address->getMobile() : '')?>" id="consigneeMobile" name="c_mobile" placeholder="Enter your 11 digit mobile number here">
