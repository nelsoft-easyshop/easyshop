            ...
            <ul class="bxslider">
                <li>
                    <div class="slider-item">
                        <img src="/assets/images/homeslider/hs_1.jpg" alt="Slider item 1">
                    </div>
                 </li>
                <li>
                    <div class="slider-item">
                        <img src="/assets/images/homeslider/hs_1.jpg" alt="Slider item 2">                        
                    </div>
                </li>
                <li>
                    <div class="slider-item">
                        <img src="/assets/images/homeslider/hs_1.jpg" alt="Slider item 3">
                    </div>
                 </li>
                <li>
                    <div class="slider-item">
                        <img src="/assets/images/homeslider/hs_1.jpg" alt="Slider item 4">                        
                    </div>
                </li>
                <li>
                    <div class="slider-item">
                        <img src="/assets/images/homeslider/hs_6.jpg" alt="Slider item 4">                        
                    </div>
                </li>
                <li>
                    <div class="slider-item">
