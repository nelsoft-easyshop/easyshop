    ...
    <div class="container pd-bttm-30">
        <div class="row">
              <div class="col-sm-12 pd-bttm-30">
                    <h1 class="email-h1-title border-bottom pd-bttm-10 text-left">TERMS &amp; CONDITIONS</h1>
                    <p>
                    ...
                    <h3 class="htitle2">Account Creation</h3>
                    <p>
                    ...
                    <h3 class="htitle2">Intellectual Property Rights</h3>
                    <p>
                    ...
                    <h3 class="htitle2">Information Submitted By User</h3>
                    <p>
                    ...
                    <p>
                        Users are prohibited from using the EasyShop.ph brand name when using the entire Website, including but not limited to:
                        <ul>
                            <li>Username</li>
                            <li>Registration Email</li>
                            <li>Seller/Merchant Name</li>
                            <li>Vanity URL</li>
                        </ul>
                    </p>
                    
                    <h3 class="htitle2">Registration as a Seller</h3>
                    <p>
                    ...
                    <p>
                        For cases where the Seller and the Buyer has agreed for a “Product Pickup” -- wherein the Buyer decides to go the Seller’s location to pick-up the item, an Official Receipt has to be provided as proof of the exchange of merchandise.
                    </p>
                    <p>
