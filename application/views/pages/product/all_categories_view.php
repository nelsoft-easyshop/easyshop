			...
			<div>
				<?php if(count($categories)>0): ?>
					...
					?>	
								...
								<li><h3><a href="<?=base_url()?>catgeory/<?php echo $category['id_cat']?>/<?php echo urlencode($category['name']);?>.html"><?php echo $category['name'];?></a></h3>
									<?php
									      ...
									      foreach($category['subcategories'] as $subcategory): 
											...
											$x++;
									?>		
										    <li><a href="<?=base_url()?>category/<?php echo $subcategory['id_cat']?>/<?php echo urlencode($subcategory['name']);?>.html"><?php echo $subcategory['name'].' ('.$subcategory['product_count'].')';?></a></li>
									<?php endforeach; ?>
									</ul>
								</li>
					<?php endforeach; ?>
