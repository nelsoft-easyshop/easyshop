...
<?php foreach ($main_categories as $category): ?>
                        <li class = <?php echo (($category['id_cat'] === $breadcrumbs[0]['id_cat']) ? "active" : ""); ?>>
                            <a href="<?= base_url() ?>category/<?php echo $category['id_cat']; ?>/<?php echo urlencode($category['name']); ?>.html">
...
<?php foreach ($breadcrumbs as $crumbs): ?>
                    <li>
                        <a href="<?= base_url() ?>category/<?php echo $crumbs['id_cat'] ?>/<?php echo urlencode($crumbs['name']) ?>.html">
        ...
        <div class="filters">           
            ...
            <div class="jcarousel category_carousel cc2_wrapper">
                <div class="cc2">
                    ...
                    <div class="">
                        <a class="cc2_title" href="<?=base_url()?>category/<?php echo $rows['id_cat'];?>/<?php echo urlencode($rows['name']);?>.html">
                        ...
                        <div class="cc2_prod_name"><a href="<?PHP echo base_url()."item/".$rows['popular'][0]['id_product']."/".urlencode($rows['popular'][0]['product']); ?>.html" title="<?PHP echo $rows['popular'][0]['product']; ?>"><span><?PHP echo $rows['popular'][0]['product']; ?></span></a></div>
...
?>
    ...
    </div> <div class="loading_products" style="display: inline-block;text-align: center;width: 100%;"></div>
    </div>
