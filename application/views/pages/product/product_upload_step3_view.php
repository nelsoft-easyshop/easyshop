  ...
  <div class="seller_product_content">
    ...
    <div class="shipping_container">
	  <?php if($attr['has_attr'] == 1):?>
		  <table cellspacing="0" cellpadding="0" width="465px">
        <thead>
          <tr>
    ...
    <input type="hidden" id="has_attr" value="<?php echo $attr['has_attr'];?>">
      ...
      <table cellspacing="0" cellpadding="0">
        ...
        <table id="shiploc_selectiontbl" class="shipping_table2" width="465px" cellspacing="0" cellpadding="0">
    ...
    <thead>
        <tr>
          <td width="210px" class="f12">Product Attribute Combinations</td>
          <td colspan="2"><span class="f12">Location</span><span class="f14">Price</span></td>
