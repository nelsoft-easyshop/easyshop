 ...
 if($typeofview == 1){
  $class = '-list';
      ...
      if(isset($items))
      {
       for ($i=0; $i < sizeof($items); $i++) { 
        ...
        <div class="product<?php echo $class; ?>">
         <a href="<?=base_url()?>item/<?php echo $items[$i]['slug']; ?>"><span class="prod_img_wrapper"><span class="prod_img_container"><img alt="<?php echo $items[$i]['product_name']; ?>" src="<?php echo base_url().$pic[0].'/'.$pic[1].'/'.$pic[2].'/'.$pic[3].'/'.'categoryview'.'/'.$pic[4];;?>"></span></span></a>
     ...
     <h3 style="  -o-text-overflow: ellipsis;    
         ...
         white-space:nowrap;  
         width: 225px; ">
         <a href="<?=base_url()?>item/<?php echo $items[$i]['slug']; ?>"><?php echo html_escape($items[$i]['product_name']); ?></a>
       </h3>
