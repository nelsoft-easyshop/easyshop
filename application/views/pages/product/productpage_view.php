  ...
  <div class="wrapper">
    ...
    <div class="prob_cat_nav">
      <div class="category_nav product_content">
        <ul>
          ...
          <li class = <?php echo (($category['id_cat'] === $breadcrumbs[0]['id_cat'])?"active":"");?>> <a href="<?=base_url()?>category/<?php echo $category['id_cat'];?>/<?php echo urlencode($category['name']); ?>.html"> <?php echo $category['name'];?> </a> </li>
          <?php endforeach;?>
        </ul>
      </div>
    </div>
    ...
    <div class="bread_crumbs">
      <ul>
        ...
        <li> <a href="<?=base_url()?>category/<?php echo $crumbs['id_cat']?>/<?php echo urlencode($crumbs['name']);?>.html"> <?php echo $crumbs['name']?> </a> </li>
        <?php endforeach;?>
    ...
    <div class="content_wrapper">
      ...
      <div class="product_inner_content_info">
        ...
        <div class="price_details">
          ...
          <div class="buy_box"> 
            ...
            <?php else: ?>
            <a href="<?PHP echo base_url();echo $logged_in?'memberpage':'login';?>" id="unablesend" class="add_to_cart"><img src="<?=base_url()?>assets/images/img_cart2.jpg"> Buy Now</a> <br />
        ...
        <p class="product_content_payment"> <strong>Payment:</strong><br />
          <img src="<?=base_url()?>assets/images/img_mastercard.png"> <img src="<?=base_url()?>assets/images/img_visa.png"> <img src="<?=base_url()?>assets/images/img_jcb.png"> </p>
      </div>
      <div class="clear"></div>
      <div id="tabs">
        <ul>
      ...
      <div class="recommendation_list">
          ...
          <ul>
            ...
            <li>
              <a href="<?=base_url()."item/".$row['id_product'].'/'.urlencode($row['product']); ?>.html">
