            ...
            <div class="wrapper">
                ...
                <div class="my_cart_content" id="row<?PHP echo $row['rowid']; ?>">
                    ...
                    <div>
                        ...
                        <a href="<?=base_url().'item/'.$row['id'].'/'.urlencode($row['name']);?>" class="has-tooltip" data-image="<?=base_url()?><?php echo $row['img'][0]['path']; ?>categoryview/<?php echo $row['img'][0]['file']; ?>"><img style="height:60px;width: 60px" src="<?=base_url()?><?php echo $row['img'][0]['path']; ?>thumbnail/<?php echo $row['img'][0]['file']; ?>"></a>
