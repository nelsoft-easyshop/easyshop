        ...
        <div class="container main-container vendor-main pos-ab edit-profile-mobile">
            <div class="vendor-profile-content" id="edit-profile-info-content">
                ...
                <div class="pd-lr-20 edit-profile-container">
                    <input type="text" id="storeNameTxt" maxlength="50" class="form-control mrgn-bttm-8 seller-name" value="<?=html_escape($arrVendorDetails['store_name']); ?>" data-origval="<?=html_escape($arrVendorDetails['store_name']); ?>" placeholder="Store Name">
