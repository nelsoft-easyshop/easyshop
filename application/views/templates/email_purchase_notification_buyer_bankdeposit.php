    ...
    <table cellspacing="0" cellpadding="10" style="width:100%; max-width:760px; margin:0 auto;border:1px solid #cecece; font-family: Arial, sans-serif; font-size:12px;">
      ...
      <tr>
        <td>
		  ...
		  <span style="display:inline-block;font-weight:bold;width:200px;">Deposit payment to:</span><br>
		  <span style="display:inline-block;font-weight:bold;width:150px;margin-left:2em;">Bank :</span> {bank_name}<br>
		  <span style="display:inline-block;font-weight:bold;width:150px;margin-left:2em;">Bank Account Name :</span> {bank_accname}<br>
		  <span style="display:inline-block;font-weight:bold;width:150px;margin-left:2em;">Bank Account # :</span> {bank_accnum}<br><br>
        </td>
      </tr>
      <tr>
        <td>
