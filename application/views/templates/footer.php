        ...
        <footer>
                ...
                <div class="copyright <?php echo isset($minborder) && $minborder ? 'copyright-min-border' : ''?>">
                    <p class='browser-disclaimer'>This page is best viewed with one of these browsers:
                        <a href='https://www.google.com/intl/en/chrome/browser/' target="_blank"><img src='/assets/images/icon_browser_chrome.png' style='margin-left:2px; margin-top:3px;'/> <span style='position:absolute;'>Chrome</span></a>
                        <a href='http://www.mozilla.org/en-US/firefox/new/' target="_blank"><img src='/assets/images/icon_browser_firefox.png' style='margin-left:50px; margin-top:3px;'/> <span style=' position:absolute; margin-left:2px;'>Firefox</span></a>
                    </p>
