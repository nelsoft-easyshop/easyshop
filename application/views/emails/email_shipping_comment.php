    ...
    <body>
        <div style="padding-right: 15px; padding-left:15px; margin-right: auto; margin-left:auto;">
            ...
            <div style="margin-top: 20px; font-size: 13px;">
                ...
                <br/>
                <p>
                    <span style="color:#f18200;font-weight:bold;">{seller}</span> has just provided new shipping details for your product
                </p>
            </div>
            <div style="margin-bottom: 20px;background-color: #fff;border: 1px solid transparent; border-radius: 4px; -webkit-box-shadow: 0 1px 1px rgba(0, 0, 0, .05); box-shadow: 0 1px 1px rgba(0, 0, 0, .05); border-color: #bce8f1; border-radius: 0px !important;">
                <div style="padding: 10px 15px; border-bottom: 1px solid transparent; color: #31708f;background-color: #d9edf7; border-color: #bce8f1; font-weight: bold;">Summary of Shipment</div>
                <div style="padding: 15px;" align="center">
                   <div style="min-height: 300px; display: static">
                        <center>
                            <div style=" width: 83.33333333333334%;">
                                <table border='0' width="100%">
                                    <tr>
                                        <td style="padding: 10px; vertical-align: top; width:50%">
                                        <div style=' min-height:260px; max-height: 290px; width: 100%; padding-right: 7px; '>
