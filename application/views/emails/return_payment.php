                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr>
                                                                <td mc:edit="content (layout-4) TB27" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    ...
                                                                    <span style="color:#ff893b; font-weight: 400;">{user}</span> has just confirmed to return your payment for the following product:
                                                               ...
                                                               <td mc:edit="heading (layout-1/1) TB13" width="auto" align="center" valign="middle" height="28" style=" background-color:#ffffff; border:1px solid #ececed; background-clip: padding-box; font-size:18px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; text-align:center;  color:#a3a2a2; font-weight: 300; padding-left:18px; padding-right:18px; ">
                                                                    <span style="color: #a3a2a2; font-weight: 300;">
                                                                        <span style="text-decoration: none; color: #a3a2a2; font-weight: 300;">
                                                                            SUMMARY OF <span style="color: #ff893b; font-weight: 300;">RETURNED PAYMENT</span>
                                                                        </span>
                                                                    </span>
                                                               </td>
                                                            </tr>
                                            ...
                                            <table width="270" border="0" cellspacing="0" cellpadding="0" align="left" style="padding-left:50px;">
                                                        ...
                                                        <table width="270" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            <tr>
                                                                ...
                                                                <td valign="bottom" style="padding-left: 10px;">
                                                                    <a href="{itemLink}" style="display: inline-block; font-size: 15px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#555555; font-weight:400; text-align:left; ">
                                                                        {product_name}
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                ...
                                                <tr>
                                                    <td valign="top" mc:edit="content (layout-2) TB21" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:400; text-align:left; ">
                                                        <span style="color: #555555; font-weight: bold; word-break: break-all;">{field} : </span>{value}
                                                    </td>
                                                </tr>
                                                {/attr}
                                                <!--start space height --> 
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="left" width="100%">
                                                            <tr>
                                                                <td mc:edit="content (layout-2) TB21" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left;">
                                                                    <table width="100%">
                                                                        <tr>
                                                                            <td valign="bottom" width="50%"  valign="top" style="color: #555555; font-weight: bold; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; word-break: break-all;">
                                                                                Transaction # : 
                                                                            </td>
                                                                            <td valign="bottom" width="50%" valign="top" align="right" style="padding-right: 40px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; word-break: break-all;">
                                                                                {invoice_no}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td valign="bottom" width="50%" valign="top" align="right" style="padding-right: 40px; font-size: 13px; font-weight: bold; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; word-break: break-all;">
                                                                                &#8369; {total}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td valign="bottom" width="50%" valign="top" colspan="2" style="text-transform: uppercase; font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#ff893b; font-weight:300; text-align:left; word-break: break-all;">
                                                                                DEDUCTIONS
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td valign="bottom" width="50%" valign="top" align="right" style="padding-right: 40px; font-size: 13px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; word-break: break-word;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td valign="bottom" width="50%" valign="top" align="right" style="padding-right: 40px; font-size: 14px; font-weight: bold; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; word-break: break-all;">
                                                                                &#8369; {net}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
