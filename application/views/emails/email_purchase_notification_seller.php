...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>EasyShop - Newsletter Template</title>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr>
                                                                <td mc:edit="content (layout-4) TB27" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    ...
                                                                    <p style="margin-top: 20px; margin-bottom: 20px;">Dear <span style="color:#ff893b; font-weight: 400;">{seller_store}</span>,</p>

                                                                    <span style="color:#ff893b; font-weight: 400;">{buyer_store}</span> purchased from you!
                                                                    <p>{payment_msg_seller}</p>
                                                                    <br/>
                                                                    Thank you for selling through <span style="color:#ff893b; font-weight: 400;">Easyshop.ph!</span> Details for the item(s) you've sold are as follows:
                                                               ...
                                                               <td mc:edit="heading (layout-1/1) TB13" width="auto" align="center" valign="middle" height="28" style=" background-color:#ffffff; border:1px solid #ececed; background-clip: padding-box; font-size:18px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; text-align:center;  color:#a3a2a2; font-weight: 300; padding-left:18px; padding-right:18px; ">
                                                                    <span style="color: #a3a2a2; font-weight: 300;">
                                                                        <span style="text-decoration: none; color: #a3a2a2; font-weight: 300;">
                                                                            TRANSACTION <span style="color: #ff893b; font-weight: 300;">DETAILS</span>
                                                                        </span>
                                                                    </span>
                                                               </td>
                                                            </tr>
                                                                ...
                                                                <td mc:edit="content (layout-2) TB21" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left;  word-break: break-all;">
                                                                    <table width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td valign="bottom" width="50%" align="left" style=" word-break: break-all;">
                                                                                {invoice_no}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td valign="bottom" width="50%" align="left" style=" font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; word-break: break-all;">
                                                                               {buyer_store}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <td mc:edit="content (layout-2) TB21" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    <table width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td valign="bottom" width="50%" align="left" style="padding-right: 10px; word-break: break-word;">
                                                                                {stateregion} 
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td valign="bottom" width="50%" align="left" style="padding-right: 10px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; word-break: break-word;">
                                                                                {city} 
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td valign="bottom" width="50%" align="left" style="padding-right: 10px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; word-break: break-all;">
                                                                                {buyer_telephone}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                        ...
                                                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                               <td mc:edit="heading (layout-1/1) TB13" width="auto" align="center" valign="middle" height="28" style=" background-color:#ffffff; border:1px solid #ececed; background-clip: padding-box; font-size:18px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; text-align:center;  color:#a3a2a2; font-weight: 300; padding-left:18px; padding-right:18px; ">
                                                                    <span style="color: #a3a2a2; font-weight: 300;">
                                                                        <span style="text-decoration: none; color: #a3a2a2; font-weight: 300;">
                                                                            SUMMARY OF <span style="color: #ff893b; font-weight: 300;">SOLD ITEMS</span>
                                                                        </span>
                                                                    </span>
                                                               </td>
                                                            </tr>
                                            ...
                                            <table width="270" border="0" cellspacing="0" cellpadding="0" align="left" style="padding-left:50px;">
                                                ...
                                                <tr>
                                                    <td valign="top" mc:edit="content (layout-2) TB21" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:400; text-align:left; ">
                                                        <span style="color: #555555; font-weight: bold; word-break: break-all;">{attr_name} : </span>{attr_value}
                                                    </td>
                                                </tr>
                                                {/attr}
                                                <!--start space height --> 
                                                                ...
                                                                <td mc:edit="content (layout-2) TB21" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    <table width="100%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td valign="bottom" width="50%" align="right" style="padding-right: 40px; font-size: 13px; font-weight: bold; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; word-break: break-all;">
                                                                                &#8369; {finalprice}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td valign="top" width="50%" colspan="2" style="text-transform: uppercase; font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#ff893b; font-weight:300; text-align:left; word-break: break-all;">
                                                                                DEDUCTIONS
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td valign="bottom" width="50%" colspan="2" style="text-transform: uppercase; font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#ff893b; font-weight:300; text-align:left; word-break: break-all;">
