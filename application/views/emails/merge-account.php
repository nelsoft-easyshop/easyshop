                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr>
                                                                <td mc:edit="content (layout-4) TB27" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                  <p style="margin-top: 20px; margin-bottom: 20px;">Dear <span style="color:#ff893b; font-weight: 400;">{username}</span>,</p>
                                                                    This is a verification request to merge with an <span style="color: #ff893b; font-weight: 400;">EasyShop.ph</span> account that uses this registered username. 
                                                                    <br/><br/>
                                                                    <span style="color: #555555; font-weight: 400;">Please click the link below to proceed with this request, where you will be required to login to your account to complete the process. </span>
                                                                    <br/><br/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                    ...
                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td mc:edit="button left (layout-5) TB42" id="mail-color" width="auto" align="center" valign="middle" height="32" style=" background-color:#4370cc;  border-radius:5px; background-clip: padding-box;font-size:13px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; text-align:center;  color:#ffffff; font-weight: 300; padding-left:18px; padding-right:18px; ">
                                                                                <a href="{mergeLink}" target="_blank" style="display: inline-block; text-decoration: none; color:#ffffff; font-weight: 300;">
                                                                                    Merge Account
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                            ...
                                                            <tr>
                                                                <td mc:edit="content (layout-4) TB27" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    If you did not initiate this request, please delete this email immediately.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="20"></td>
