                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr>
                                                                <td mc:edit="content (layout-4) TB27" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    ...
                                                                    <br/><br/> <span style="color:#555555; font-weight: 400;">If you'd like to re-activate your account, <a href="#" style="color:#ff893b; font-weight: 400;">click here</a> to start the re-activation process.</span>
                                                                    <br/><br/>If you did not initiate this request, please delete this email immediately.
                                                                </td>
                                                            </tr>
