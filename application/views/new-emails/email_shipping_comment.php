                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr>
                                                                <td mc:edit="content (layout-4) TB27" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    ...
                                                                    <p style="margin-top: 20px; margin-bottom: 20px;">Dear <span style="color:#ff893b; font-weight: 400;">BuyerName</span>,</p>

                                                                    <span style="color:#ff893b; font-weight: 400;">SellerName</span> has just provided new shipping details for your product                                                                    
                                                                </td>
                                                            </tr>
                                                               ...
                                                               <td mc:edit="heading (layout-1/1) TB13" width="auto" align="center" valign="middle" height="28" style=" background-color:#ffffff; border:1px solid #ececed; background-clip: padding-box; font-size:18px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; text-align:center;  color:#a3a2a2; font-weight: 300; padding-left:18px; padding-right:18px; ">
                                                                    <span style="color: #a3a2a2; font-weight: 300;">
                                                                        <span style="text-decoration: none; color: #a3a2a2; font-weight: 300;">
                                                                            SHIPMENT <span style="color: #ff893b; font-weight: 300;">DETAILS</span>
                                                                        </span>
                                                                    </span>
                                                               </td>
                                                            </tr>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="left" width="100%">
                                                            <tr>
                                                                <td mc:edit="content (layout-2) TB21" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    <table width="100%">
                                                                        <tr>
                                                                            <td width="50%" valign="top" style="color: #555555; font-weight: bold; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif;">
                                                                                Transaction # : 
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="50%" valign="top" align="left" style=" font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif;">
                                                                ...
                                                                <td mc:edit="content (layout-2) TB21" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    <table width="100%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="50%" valign="top" align="left" style="padding-right: 10px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif;">
                                                                                JRS Express 
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr>
                                                                <td mc:edit="content (layout-4) TB27" style="font-size: 13px; line-height: 22px; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color:#a3a2a2; font-weight:300; text-align:left; ">
                                                                    ...
                                                                    <p style="margin-bottom: 10px; font-weight: bold; font-family:Roboto,Open Sans, Arial,Tahoma, Helvetica, sans-serif; color: #555;">Comment: </p>

                                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hunc quales posidonium fana mundus subtilius magnus, nominant, dominationis asperum dominationis inliberali conversam bello approbantibus disseruerunt sermone. Generibusque iucunde alia dedocendi miseram nudus curis discedere, expetendam inviti acute certissimam falsarum, expeteretur accusamus dissentio cernantur, expetendum divitiarum sensuum senserit propemodum studium. Municipem consule. Conversa impendet propositum invenire tantis antiquis, cupiditates stoicis exiguam etsi orestem. Scripta reformidans opera quibus familias, uberiora quippe nobis titillaret minime habeatur habuit geometria adolescens defensa, docet sapiente gubernatoris exaudita.
                                                                </td>
                                                            </tr>
