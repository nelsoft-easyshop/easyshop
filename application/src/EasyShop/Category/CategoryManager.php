...
class CategoryManager
{
     ...
     */
    public function getProductsWithinCategory($memberId, $arrCatId, $isCustom = false , $productLimit = 12, $page = 0, $orderBy = [ self::ORDER_PRODUCTS_BY_SORTORDER => 'DESC' ] , $condition = "", $lprice = "", $uprice ="")
    {
