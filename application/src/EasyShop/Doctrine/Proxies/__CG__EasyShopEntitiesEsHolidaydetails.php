 ...
 */
class EsHolidaydetails extends \EasyShop\Entities\EsHolidaydetails implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EasyShop\\Entities\\EsHolidaydetails' . "\0" . 'id', '' . "\0" . 'EasyShop\\Entities\\EsHolidaydetails' . "\0" . 'dateD', '' . "\0" . 'EasyShop\\Entities\\EsHolidaydetails' . "\0" . 'memo', '' . "\0" . 'EasyShop\\Entities\\EsHolidaydetails' . "\0" . 'type');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EsHolidaydetails $proxy) {
