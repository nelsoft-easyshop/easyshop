 ...
 */
class EsSchool extends \EasyShop\Entities\EsSchool implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EasyShop\\Entities\\EsSchool' . "\0" . 'id', '' . "\0" . 'EasyShop\\Entities\\EsSchool' . "\0" . 'schoolname', '' . "\0" . 'EasyShop\\Entities\\EsSchool' . "\0" . 'year', '' . "\0" . 'EasyShop\\Entities\\EsSchool' . "\0" . 'level', '' . "\0" . 'EasyShop\\Entities\\EsSchool' . "\0" . 'count', '' . "\0" . 'EasyShop\\Entities\\EsSchool' . "\0" . 'idMember');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EsSchool $proxy) {
