 ...
 */
class EsProductShippingHead extends \EasyShop\Entities\EsProductShippingHead implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EasyShop\\Entities\\EsProductShippingHead' . "\0" . 'idShipping', '' . "\0" . 'EasyShop\\Entities\\EsProductShippingHead' . "\0" . 'price', '' . "\0" . 'EasyShop\\Entities\\EsProductShippingHead' . "\0" . 'product', '' . "\0" . 'EasyShop\\Entities\\EsProductShippingHead' . "\0" . 'location');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EsProductShippingHead $proxy) {
    ...
    public function getIdShipping()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdShipping();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdShipping', array());

        return parent::getIdShipping();
    }
