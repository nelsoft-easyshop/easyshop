 ...
 */
class EsAddress extends \EasyShop\Entities\EsAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'idAddress', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'address', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'type', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'telephone', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'mobile', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'consignee', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'lat', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'lng', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'city', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'country', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'stateregion', '' . "\0" . 'EasyShop\\Entities\\EsAddress' . "\0" . 'idMember');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EsAddress $proxy) {
