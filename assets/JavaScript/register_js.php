...
$(document).ready(function(){
	  ...
	  $('#captcha_refresh').click(function(){
		   ...
		   $.post('<?PHP echo base_url(); ?>'+"register/recreate_captcha", function(data){
...
/**********************************************************************************************/
	  ...
	  function pass_check(){
			...
			$.post('<?php echo base_url();?>' + 'register/pass_check', {username: username, pass: pass}, function(result){
				if(result == 1){
					showcheck($('#username'));
					$('#username_check').hide();
					$('#username_x').show();
...
/**********************************************************************************************/	
	...
	$('#register_form2_a').validate({
		...
		submitHandler: function(form){
			...
			$.post('<?php echo base_url();?>' + 'register/send_verification_code', $('#register_form2_a').serializeArray(),function(data){
	...
	function username_check(){
		...
		$.post('<?php echo base_url();?>' + 'register/username_check', {username: username}, function(result){
			if(result == 1){
				showcheck($('#username'));
...
function form2validation(){		
		$('#register_form2_b').validate({
			...
			submitHandler: function(form){
				$.post('<?php echo base_url();?>' + 'register/mobile_verification', $('#register_form2_b').serializeArray(),function(data){
					if(data){
						$('#verification_code').addClass('verified');
						$.modal.close();
						$.post('<?php echo base_url();?>' + 'register/success_mobile_verification',{mobile_verify: 'submit_mobilenum'}, function(data){
							if(data){
