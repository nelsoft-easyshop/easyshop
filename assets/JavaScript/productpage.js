    ...
    jQuery(document).on('click', '#send.enabled', function(){
		...
		return false;
            ...
            $.ajax({
                ...
                type:"POST",
                dataType:"JSON",
                data:{id:i_id,qty:i_qty,pitemid:i_itemid,price:i_price,opt:i_opt,name:i_name,length:length,es_csrf_token:csrftoken,max_qty:max_qty,location_id:i_loc,location:i_loc_name},
