...
| -------------------------------------------------------------------*/
	...
	#$config['img_path'] = '/easyshop/assets/product/product_description/'; // Relative to domain name
	$config['img_path'] = '/assets/product/product_description'; 
...
| -------------------------------------------------------------------*/
	...
	// UPDATE dialog-v4.js as well for upload list display accuracy
