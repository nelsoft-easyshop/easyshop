...
insert  into `es_attr`(`id_attr`,`cat_id`,`name`,`datatype_id`,`attr_lookuplist_id`) values (2,2,'COLOR',3,1),(4,6,'SIZE',5,1);
...
insert  into `es_product`(`id_product`,`name`,`sku`,`brief`,`description`,`keywords`,`price`,`brand_id`,`cat_id`,`style_id`,`is_real`,`is_delete`,`is_new`,`is_hot`,`is_promote`,`member_id`,`member_memo`,`createddate`,`lastmodifieddate`,`clickcount`) values (11,'asdf','123445667789876543','asd','asd','KEYWORD',12,1,11,1,0,0,0,0,0,1,'','2013-12-17 09:36:28','2013-12-17 09:36:28',0),(12,'asdf','123445667789876543','asd','asd','KEYWORD',12,1,11,1,0,0,0,0,0,1,'','2013-12-17 09:38:17','2013-12-17 09:38:17',0),(13,'asdf','123445667789876543','asd','asd','KEYWORD',12,1,11,1,0,0,0,0,0,1,'','2013-12-17 09:38:30','2013-12-17 09:38:30',0),(14,'asdf','123445667789876543','asd','asd','KEYWORD',12,1,11,1,0,0,0,0,0,1,'','2013-12-17 09:50:57','2013-12-17 09:50:57',0);
...
insert  into `es_product_attr`(`id_product_attr`,`product_id`,`attr_id`,`attr_value`,`attr_price`) values (1,14,2,'BLACK',0),(2,14,4,'RED',0),(3,14,4,'BLUE',0),(4,14,4,'YELLOW',0),(5,14,4,'GREEN',0),(6,14,4,'PINK',0),(7,14,4,'WHITE',0),(8,14,4,'BLACK',0),(9,14,4,'GRAY',0);
